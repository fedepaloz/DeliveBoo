...
<div class='alert alert-danger'>
        ...
        @if ($item->exists)
        <form id="edit-item-form" action="{{ route('admin.items.update', $item) }}" enctype="multipart/form-data"
        method="POST">
        @method('PUT')
        @else
        <form id="edit-item-form" action="{{ route('admin.items.store') }}" enctype="multipart/form-data" method="POST"
        novalidate>
        @endif
