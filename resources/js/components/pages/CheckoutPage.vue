        ...
        <form class="needs-validation" novalidate="">
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input
                ...
                required=""
              />
              <div class="invalid-feedback">Il nome deve essere inserito</div>
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="mb-3">
            ...
            <input
              ...
              required=""
            />
            <div class="invalid-feedback">Inserire l'indirizzo di consegna</div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <small class="text-muted"
                >Nome completo come viene mostrato sulla carta</small
              >
              <div class="invalid-feedback">
